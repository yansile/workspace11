package construchor;
//、写一个名为Account的类模拟银行账户。该类的属性和方法如下（利息按月累计）：
//        属性：id，balance，annulInterestRate
//        方法：Account（），Account（int id，double balance, double annualInterestRate)，getId()，
...
//        写一个测试程序测试Account类。在测试程序中，创建一个账号为1110，余额为20000元、
// 年利率为4.5%的Account对象。假设该账户于1月初在银行开户，在5月底使用withdraw（）方法提款5000元，
